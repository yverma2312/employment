...
const InstructionsRequestSubmissionUnderCNVAct1959 = () => {
  return (
    <>
      <section>
        <MenuBar />
          ...
          <div className="InnerSectionBox">
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <i className="mdi mdi-numeric-1-box icon"></i>Age relaxation
                    for Category/ Gender
                  </li>
                  <li>
                    <i className="mdi mdi-numeric-2-box icon"></i>Age specified
                    to be completed on particular date
                  </li>
                  <li>
                    <i className="mdi mdi-numeric-3-box icon"></i>Physically
                    Disabled Category to be specific etc.
                  </li>
                  <li>
                    Kindly mention the same in the Remarks column in not more
                    than 100 words.
                  </li>
                </ul>
              </li>
...
export default InstructionsRequestSubmissionUnderCNVAct1959;
