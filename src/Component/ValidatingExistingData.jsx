      ...
      <section>
        ...
        <div className="InnerSection">
          <div className="InnerSectionBox">
            <h4>Procedure for Validating Existing Data</h4>
            <ul>
              <li>
                <i className="mdi mdi-numeric-1-box-multiple-outline icon"></i>
                Read the important instructions given below carefully before
                clicking on “Confirm & Update” button.
              </li>
              <li>
                <i className="mdi mdi-numeric-1-box-multiple-outline icon"></i>
                Enter existing registration details. All fields are mandatory.
              </li>
              <li>
                <i className="mdi mdi-numeric-1-box-multiple-outline icon"></i>
                After entering the details,if your existing details are not
                retrieved,
                <ul>
                  <li>
                    <i className="mdi mdi-numeric-1-box icon"></i>Click on
                    Search Data
                  </li>
                  <li>
                    <i className="mdi mdi-numeric-2-box icon"></i>Enter the
                    relevant details and click on Submit.
                  </li>
                  <li>
                    <i className="mdi mdi-numeric-3-box icon"></i>
                    If your data is available in the Search list, click on the
                    'Renew' button and authenticate yourself by entering your
                    Date of Birth.
                  </li>
                  <li>
                    <i className="mdi mdi-numeric-4-box icon"></i>
                    If your data is not available in the Search list, kindly
                    intimate at help.dee@gmail.com quoting your 'Js'-id.
                  </li>
                </ul>
              </li>
              <li>
                <i className="mdi mdi-numeric-4-box-multiple-outline icon"></i>
                If details are retrieved, it will be displayed on top of the
                webpage and in the respective fields. Verify the existing data,
                update wrong entries
              </li>
              <li>
                <i className="mdi mdi-numeric-5-box-multiple-outline icon"></i>
                Enter/Select other required fields and click on ‘Continue’.
              </li>
              <li>
            ...
            <div className="importantInstruction">
              ...
              <ul>
                ...
                <li>
                  <i className="mdi mdi-numeric-4-box icon"></i>The
                  Re-Registration Process consists of TWO Steps: Providing Basic
                  Details and Providing Qualification & Experience Details.
                </li>
                <li>
                  <i className="mdi mdi-numeric-5-box icon"></i>In the first
                  Form, Please fill in the mandatory fields (Point 1) that are
                  not entered/ selected already.
                </li>
                <li>
                  <i className="mdi mdi-numeric-6-box icon"></i>The Name of the
                  Candidate should be entered in 3 parts : First Name, Middle
                  Name and Last/SurName.
                </li>
                <li>
                  <i className="mdi mdi-numeric-7-box icon"></i>In the second
                  Form, re-enter your qualification, experience and language
                  details. (Should be the same as the details you have already
                  entered previously.)
                </li>
                <li>
                  <i className="mdi mdi-numeric-8-box icon"></i>Click on 'Add'
                  to enter further details.
                </li>
              </ul>
            </div>
            <NavLink to="/CheckForExistingUsers">
              <button
                type="button"
...
export default ValidatingExistingData;
